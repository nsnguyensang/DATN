...
alo_bds.processValueNull(["direct","bedroom", "price", "floor", "juridical", "length","width", "world_highway", "ward", "province", "district", "street", "project", "garden", "pool"],["None","0 pn", "0", "0 t", "Sổ hồng", "0m", "0m", "0m","None", "None", "None", "None", "None", "0", "0"])
alo_bds.dropDuplicate(['province', 'district', 'ward', 'street', 'type', 'direct', 'price', 'length', 'width', 'area', 'bedroom', 'floor', 'world_highway', "project"])
alo_bds.process()
alo_bds.data.to_csv("alomuabannhadat.csv", encoding = 'utf-8')