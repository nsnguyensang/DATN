...
collection = db['estateCollection_v2']  # Thay đổi tên collection tùy theo mong muốn

# Đường dẫn đến file CSV
csv_file_path = 'C:/Workspace/DATN/schema-matching/output/data_clean_mongo_ver2.csv'  # Thay đổi tên file CSV tùy theo đường dẫn thực tế
