        ...
        <div className="web-detail">
          ...
          <ShortInfo>
            <ShortInfoItem>
              ...
              <ShortInfoExt>~ {pricePerProcess(data)} triệu/m²</ShortInfoExt>
            </ShortInfoItem>
          ...
          <DescriptionDetail>
            ...
            <div>
              <InfoOther>
                ...
                <InfoOtherValue>{Math.floor(data.square)} m²</InfoOtherValue>
              </InfoOther>
              <InfoOther>
              ...
              <InfoOther>
                ...
                <InfoOtherValue>
                  {data?.direct !== "None" ? data?.direct : "Không xác định"}
                </InfoOtherValue>
              </InfoOther>
              <InfoOther>
